...
export function DebugJSONBin() {
    ...
    const runDebugTest = async () => {
        ...
        try {
            // Test 1: Try to create a simple bin to test API key validity
    ...
    return (
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6" data-oid="z-df_o8">
            <h3 className="font-bold mb-2" data-oid="y3b0noe">
                JSONBin Debug Info
            </h3>
            <button
